...
CREATE TABLE entrenador (
    ...
    FOREIGN KEY (entrenador_id) REFERENCES people(person_id),
    CONSTRAINT ra_01_especialidad CHECK (especialidad IN ('Individual', 'Dobles'))
);
...
-- ============================================================================
-- RA-02: Un entrenador no puede entrenar a 2 jugadores simultaneamente
-- ============================================================================
...
BEGIN
   ...
   if NEW.activo = true then  
	    ...
	    IF v_count >= 2 THEN
	        SIGNAL SQLSTATE '45000'
	        SET MESSAGE_TEXT = 'RA-02: Un entrenador no puede entrenar a 2 jugadores simultaneamente';
	    END IF;
	END if;
END //
