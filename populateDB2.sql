...
DELIMITER //
CREATE OR REPLACE PROCEDURE p_populate_db2()
BEGIN
    -- Limpiar datos (orden seguro por claves foráneas)
    DELETE FROM entradas;
	 DELETE FROM sets;
    DELETE FROM matches;
    DELETE FROM aficionados;
	 DELETE FROM players;
    ...
    INSERT INTO people (person_id, name, age, nationality) VALUES
        ...
        (18, 'Diego Fernandez', 50, 'Argentina'),
		  (19, 'Ana García', 28, 'España'),
    	  (20, 'Lucas Martínez', 34, 'México'),
    	  (21, 'Sofía López', 22, 'Colombia'),
   	  (22, 'Miguel Torres', 41, 'Chile'),
    	  (23, 'Laura Fernández', 30, 'Perú');
    ...
    -- Aficionados
    INSERT INTO aficionados (aficionado_id) VALUES 
        (19),
        (20),
        (21),
        (22),
    ...
    -- Entradas
    INSERT INTO entradas (entrada_id, aficionado_id, match_id, precio, localidad, fecha_entrada) VALUES
        (1, 19, 1, 10.00, 'Sevilla', '2023-07-14'),
        (2, 20, 2, 25.00, 'Cordoba', '2023-06-09'),
        (3, 21, 3, 23.00, 'Jaen', '2023-04-30'),
        (4, 22, 4, 14.00, 'Malaga', '2023-10-10'),
        (5, 23, 5, 16.00, 'Huelva', '2023-09-01');
END //
DELIMITER ;
